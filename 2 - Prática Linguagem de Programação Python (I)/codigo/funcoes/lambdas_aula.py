...
# sinceramente nao sei pq, mas quando faço lambda e executo ele transforma automaticamente numa função (def)
# na videoaula nao fica assim, por isso fiquei encucado
...
notas_alunos_aprovados = list(
    map(obter_nota, alunos_aprovados))  # pega so as notas map
